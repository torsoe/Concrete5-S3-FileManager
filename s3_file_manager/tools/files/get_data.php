...
foreach($files as $f) {
	...
	$resp[$i]['filePathInline'] = (defined('S3_ENABLED') && S3_ENABLED == true) ? $f->getRelativePath() : View::url('/download_file', 'view_inline', $f->getFileID());        
	$resp[$i]['filePath'] = (defined('S3_ENABLED') && S3_ENABLED == true) ? $f->getRelativePath() : View::url('/download_file', 'view', $f->getFileID());
